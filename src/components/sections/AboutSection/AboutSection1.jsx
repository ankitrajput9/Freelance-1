  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        {/* LEFT SIDE — CONTENT */}
        <div>
          <h2 className="text-[#d9c08f] text-3xl sm:text-4xl font-light tracking-[0.15em] mb-6">
            ABOUT US
          </h2>
        ...
        <div className="relative">
          <div className="relative z-10 rounded-xl overflow-hidden shadow-xl">
            <img
              src="/About/maavais.jpg"   // replace with your image
              alt="About Maa Vaishnavi Entertainments"
              loading="lazy"
              className="  sm:h-[400px] md:h-[450px] w-full object-cover border border-[#d9c08f] p-2 "
            />
          </div>
        </div>
      </div>
