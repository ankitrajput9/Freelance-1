  ...
  return (
    <section
      className="w-full py-16 sm:py-20 md:py-24 px-4 sm:px-6
                 text-center bg-[#f7f7f7] text-[#111]"
    >
      {/* Logo */}
      <div className="flex justify-center mb-6">
        <img
          ...
          className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 opacity-90"
        />
      </div>
      ...
      <div
        className="border border-[#ddd] bg-white
                   ...
                   max-w-3xl mx-auto mb-8 shadow-sm"
      >
        <p
      ...
      {/* Description */}
      <p
        className="max-w-4xl mx-auto leading-7
